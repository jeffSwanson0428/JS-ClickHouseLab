...
# Accepts path to manifest as a string
...
delete_manifest_if_exists "$LAB_ROOT/manifests/chi/clickhouse-installation.yaml"
echo "### Deleting Clickhouse Keeper ###"
delete_manifest_if_exists "$LAB_ROOT/manifests/keeper/clickhouse-keeper.yaml"
echo "### Deleting Altinity Clickhouse Operator ###"
delete_manifest_if_exists "$LAB_ROOT/manifests/operator/clickhouse-operator.yaml"
